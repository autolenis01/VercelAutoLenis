...
- Guard `prisma generate` so missing `POSTGRES_PRISMA_URL` does not hard-fail (e.g., set a placeholder URL or conditionally skip generate in scripts when the var is absent).

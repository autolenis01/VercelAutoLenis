...
export default function BuyerDocumentsPage() {
  ...
  // In a real app, this would fetch from /api/buyer/documents
  const { data, error, isLoading } = useSWR("/api/buyer/documents", fetcher, {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Upload and manage your financing documents"
        primaryAction={
      ...
      {documents.length === 0 ? (
        <EmptyState
          ...
          description="Upload your driver's license and proof of income to get started with your financing request"
          primaryCta={{
